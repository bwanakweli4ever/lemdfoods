        ...
        <div className="container mx-auto px-4 flex justify-between items-center text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-emerald-700 rounded text-xs">USD</span>
              <span className="px-2 py-1 bg-emerald-700 rounded text-xs">EUR</span>
              <span className="px-2 py-1 bg-emerald-700 rounded text-xs">GBP</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-1.5">
          <div className="flex items-center justify-between">
            ...
            {/* Navigation Links */}
            <div className="flex items-center gap-6 overflow-x-auto whitespace-nowrap text-sm md:text-base">
